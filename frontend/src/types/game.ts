// Domain types mirroring aidlc-docs/construction/frontend/functional-design/domain-entities.md
// These shapes are the shared contract with the Backend unit's StateQueryService output.
...
// AI via a heuristic (mockGameEngine.selectAiTrump). Replaces the previous automatic random "cut
// for trump". TRUMP_REVEAL is then a brief pause showing the chosen suit before trick play begins.
